...
echo "  The format of the secret should be user:github_access_token, for example: mockitoguy:qq43234xc23x23d24d"
git push --quiet https://$GIT_SECRET@github.com/shipkit/shipkit-demo.git $TAG_NAME > /dev/null 2>&1
EXIT_CODE=$?
